...
echo ""
echo "  Current state: [$COMMITS assertions : $DENIALS rejections]"
echo ""
echo "Terminology (Restall 2004):"
echo "  State [X : Y] = what you assert (X) and deny (Y)"
echo "  Sequent X ⊢ Y = claim that state [X : Y] is incoherent"
